...
build: ## Build PolyDev
	@docker buildx build --platform linux/amd64 -t ifunky/polydev:latest .
...
build/aws: ## Build AWS CLI and other related tools
	@docker buildx build --platform linux/amd64 -t ifunky/polydev-aws:latest -f dockerfiles/aws/Dockerfile dockerfiles/aws/

build/aws/nocache: ## Build AWS CLI and other related tools (from scratch)
	@docker buildx build --platform linux/amd64 --no-cache -t ifunky/polydev-aws:latest -f dockerfiles/aws/Dockerfile dockerfiles/aws/
